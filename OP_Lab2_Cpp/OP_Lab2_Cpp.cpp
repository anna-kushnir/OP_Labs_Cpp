...
int main() {
	...
	if (b1 != 0 && b2 != 0 && b3 != 0) {
		if (a1 / b1 == a2 / b2 && a2 / b2 == a3 / b3) cout << "Вектори a i b колiнеарнi" << endl;     //Умова колінеарності векторів
		else cout << "Вектори a i b не є колiнеарними" << endl;
	}
	else {
		if (a1 == a2 == a3 == 0 || b1 == b2 == b3 == 0) cout << "Вектори a i b колiнеарнi" << endl;   //Нульовий вектор колінеарний будь-якому іншому вектору
